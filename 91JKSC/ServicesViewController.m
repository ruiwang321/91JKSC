...
@interface ServicesViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
{
    MBProgressHUD *_hud;
}
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithRed:0.76f green:0.77f blue:0.77f alpha:1.00f];
    [self createNavWithLeftImage:@"img_arrow" andRightImage:@[@"cart",@"search"] andTitleView:nil andTitle:self.titleName andSEL:@selector(leftBtn:) ];
...
-(void)createCollectionView{
    ...
    headerFlowLayout.itemSize = CGSizeMake(SYS_WIDTH/2-10, 80);
    ...
    [self.collectionView registerClass:[ServiceCollectionViewCell class] forCellWithReuseIdentifier:@"ServiceCollectionViewCell"];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *cellID = @"ServiceCollectionViewCell";
    
    ServiceCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
    
    TradeModel *model = [self.listArr objectAtIndex:indexPath.row];
    
    [cell createCellWithModel:model andIndex:0];
