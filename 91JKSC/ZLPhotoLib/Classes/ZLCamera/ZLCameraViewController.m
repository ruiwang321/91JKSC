...
- (void) initialize
{
    ...
    ZLCameraView *caramView = [[ZLCameraView alloc] initWithFrame:CGRectMake(0, 64, self.view.zl_width, self.view.zl_height - 64 - BOTTOM_HEIGHT)];
...
- (void) setup{
    ...
    topView.frame = CGRectMake(0, 0, self.view.zl_width, 64);
