...
- (void)createSubView {
    ...
    [backBtn setImage:[UIImage imageNamed:@"img_scan_back"] forState:UIControlStateNormal];
    [self.view addSubview:backBtn];
    
    _flashBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    _flashBtn.frame = CGRectMake(SYS_WIDTH/2 - 22, 20, 44, 44);
    [_flashBtn setImage:[UIImage imageNamed:@"img_scan_shanguang"] forState:UIControlStateNormal];
    [_flashBtn setImage:[UIImage imageNamed:@"sanguangdeng-wu"] forState:UIControlStateSelected];
    ...
    _photoBtn.frame = CGRectMake(SYS_WIDTH - 64, 20, 44, 44);
    [_photoBtn setImage:[UIImage imageNamed:@"img_scan_picture"] forState:UIControlStateNormal];
    [_photoBtn addTarget:self action:@selector(clickRightBarButton:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    for(AVMetadataObject *current in metadataObjects) {
        ...
        NSLog(@"二维码结果:%@",scannedResult);
            [MBProgressHUD showSuccess:scannedResult];
            [self stopScanning];
...
-(void)clickRightBarButton:(UIButton *)item
{
